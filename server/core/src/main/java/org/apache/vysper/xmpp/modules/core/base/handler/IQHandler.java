 ...
 * @see org.apache.vysper.xmpp.modules.core.base.handler.async.AbstractAsyncIQGetHandler
...
public class IQHandler extends XMPPCoreStanzaHandler {
	...
	protected Stanza executeCore(XMPPCoreStanza coreStanza, ServerRuntimeContext serverRuntimeContext,
		...
		logger.debug("processing stanza {} from " + stanza.getFrom() + " with instance {}", stanza.getID(),
				getClass().getName());
